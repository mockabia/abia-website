...
function RenderEnquiries(props) {
  ...
  return (
    <>
        ...
        return (
          <div className="active-enquiry-mobile">
            <div className=" flex justify-between items-center gap-[1rem]">
              ...
              >
                <img src={enquiry.imageUrl} className="enquiry-vendor-image" />
                ...
                <div className="cursor-pointer">
                  <BlackSmallButton>
                    {enquiry.status === "0" ? (
                      ...
                      <h6>
                        <Link to={window.CHAT}>Reply</Link>
                      </h6>
                    )}
                  </BlackSmallButton>
                </div>
                ...
                >
                  ...
                  {archieved != "1" && (
                    <td>
                      <BlackLargeButton>
                        {enquiry.status === "0" ? (
                          <h6 onClick={() => toggleOpen(enquiry)}>
                            View Enquiry
                          </h6>
                        ) : (
                          <h6>
                            <Link to={window.CHAT}>Reply to Vendor</Link>
                          </h6>
                        )}
                      </BlackLargeButton>
                    </td>
      ...
      {detailOpen && (
        <DetailedEnquiry
          enquiry={clickedEnquiry}
          open={detailOpen}
          setOpen={setDetailOpn}
        />
      )}
    </>
  );
