  ...
  return (
    <div>
      ...
      <div className="mobile-content">
        ...
        <div
          style={{
            fontFamily: "'Nimbus Sans L', sans-serif",
            fontSize: "14px",
            color: "#8e8e8e",
          }}
          className="sub-description-N"
        >
          {parentDesc}
        </div>
          ...
          {blogResults.map((blog, j) => (
            <Link to={`/${blog.url}`} key={blog.id}>
              <div className="mob-blog-box">
                ...
                />
                <h3 style={{ fontFamily: "'Nimbus Sans L'" }}>{blog.title}</h3>
                <p style={{ fontFamily: "'Nimbus Sans L'" }}>
                  {blog.short_bcomment}
                </p>
              </div>
            </Link>
            ...
            <Link to={`/${blog.url}`} key={blog.id}>
              <div className="first-image-desktop">
                ...
                <div className="first-blog-content">
                  <h2 style={{ fontFamily: "'Nimbus Sans L'" }}>
                    {blog.title}
                  </h2>
                  <p style={{ fontFamily: "'Nimbus Sans L'" }}>
                    {blog.short_bcomment}
        ...
        <div className="four-column-blogs">
          {fourColumnblogs.map((blog, j) => (
            ...
            >
              ...
              <p style={{ fontFamily: "'Nimbus Sans L', sans-serif" }}>
                {blog.short_bcomment}
              </p>
            </Link>
          ))}
