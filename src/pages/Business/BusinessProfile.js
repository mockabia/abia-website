...
const Profile = ({ preview }) => {
  ...
  const handleQuestionSave = () => {
    ...
    setQuestionDisplay((prevQuestionDisplays) => [
      ...prevQuestionDisplays,
      newQuestionDisplay,
    ]);

    console.log("formValues:", {
      qanda: questionDisplay,
    });
  };
  useEffect(() => {
  ...
  const handlePricingSubmit = () => {
    ...
    console.log("formValues:", {
      ...dynamicFields.reduce((acc, field) => {
        ...
        console.log(
          `Field name: ${fieldName}, price: ${fieldPrice}, Display Price: ${fieldDisplayStatus}`
        );
        return {
          ...acc,
              ...
              <div>
                ...
                {dynamicFields.map((field, index) => (
                  <div className="mt-[0px]" key={field.id}>
                    <div>
                      <div className="pricing-category-lbael">
                        {field.label}
                      </div>
                      {/* pricing input */}
                      <div className="mt-[10px] relative">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handlePricingInputsChange(field.id, e.target.value)
                          }
                        />
                      </div>
                      ...
                      <div>
                        ...
                        {field.id === "Wedding_Venues" && (
                          <>
                            ...
                            <Stack spacing={1} direction="row">
                              <div className="pricing-addon-label ">
                                <span className="">Venue Service Settings:</span>
                              </div>
                              <FormControl>
                                <FormGroup
                                  sx={{
