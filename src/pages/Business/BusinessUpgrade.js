...
import "../Style/BusinessUpgrade.css";
...
const BusinessUpgrade = () => {
  ...
  return (
    <div className="h-screen pb-[10rem]">
      {/* toggle switch */}
      <h2 className="upg-main-header">Partnetship Benefits</h2>
      <div className="upg-toggle-div">
        <h5>Monthly</h5>
        <button onClick={onClickHandler} className="toggle-switch">
          <div
            className="upg-benefit-button"
            style={{
      ...
      {/* main section */}
      <main className="upg-partnership-main">
        {/* Box 1 */}
        <div className="upg-partnership-box-one">
          <div className="upg-partnership-info-box">
            <div className="flex flex-col gap-[1.5rem]">
              ...
              >
                <button className="upg-partnership-apply-button">
                  Apply Today
                </button>
              </Link>
              ...
              <div className="upg-featurelist-header" onClick={handleOpen}>
        ...
        {/* Box 2 */}
        <div className="upg-partnership-box-two">
          <div className="upg-partnership-info-box">
            <div className="flex flex-col gap-[1.5rem]">
              <div>
                <span>
              ...
              <div className="upg-featurelist-header" onClick={handleOpen_F}>
                {moreButtonText2}
